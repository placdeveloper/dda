...
/**
 * GeraBoletoLegadoAPIDto é responsável por
 * 
 * @author George.santos
 */
public class BoletoLegadoAPIDto extends BancoobDto {
    ...
    private DateTime dataCartaRemessa;
    private String descSeuNumero;
    private DateTime dataEmissaoDocumento;
    ...
    private DateTime dataPrimDesconto;
    private BigDecimal valorPrimDesconto;
    private DateTime dataSegDesconto;
    private BigDecimal valorSegDesconto;
    private DateTime dataTerDesconto;
    ...
    private DateTime dataEnvioProtesto;
     ...
     */
    public DateTime getDataCartaRemessa() {
     ...
     */
    public void setDataCartaRemessa(DateTime dataCartaRemessa) {
     ...
     */
    public DateTime getDataEmissaoDocumento() {
     ...
     */
    public void setDataEmissaoDocumento(DateTime dataEmissaoDocumento) {
     ...
     */
    public DateTime getDataVencimentoTitulo() {
     ...
     */
    public void setDataVencimentoTitulo(DateTime dataVencimentoTitulo) {
     ...
     */
    public DateTime getDataPrimDesconto() {
     ...
     */
    public void setDataPrimDesconto(DateTime dataPrimDesconto) {
     ...
     */
    public DateTime getDataSegDesconto() {
     ...
     */
    public void setDataSegDesconto(DateTime dataSegDesconto) {
     ...
     */
    public DateTime getDataTerDesconto() {
     ...
     */
    public void setDataTerDesconto(DateTime dataTerDesconto) {
     ...
     */
    public DateTime getDataLiquidacao() {
     ...
     */
    public void setDataLiquidacao(DateTime dataLiquidacao) {
     ...
     */
    public DateTime getDataEnvioProtesto() {
     ...
     */
    public void setDataEnvioProtesto(DateTime dataEnvioProtesto) {
     ...
     */
    public DateTime getDataPrevisaoCredito() {
     ...
     */
    public void setDataPrevisaoCredito(DateTime dataPrevisaoCredito) {
     ...
     */
    public DateTime getDataEmissaoAvSacado() {
     ...
     */
    public void setDataEmissaoAvSacado(DateTime dataEmissaoAvSacado) {
     ...
     */
    public DateTime getDataBordero() {
        return dataBordero;
    }
     ...
     */
    public void setDataBordero(DateTime dataBordero) {
