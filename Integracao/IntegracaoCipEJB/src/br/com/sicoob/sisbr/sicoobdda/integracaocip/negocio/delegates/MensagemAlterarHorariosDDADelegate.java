...
/**
 * MensagemAlterarHorariosDDADelegate é responsável por
 * 
 * @author Daniel.Moraes
 */
public class MensagemAlterarHorariosDDADelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemAlterarHorariosDDAServico {
     ...
     */
    @Override
    protected MensagemAlterarHorariosDDAServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemAlterarHorariosDDAServico();
    }
