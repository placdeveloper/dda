...
/**
 * MensagemConsultarPagadorDelegate
 * 
 * @author George.Santos
 */
public class MensagemConsultaPagadorDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemConsultaPagadorServico {
     ...
     */
    @Override
    protected MensagemConsultaPagadorServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemConsultarPagadorServico();
    }
