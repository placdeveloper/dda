...
/**
 * MensagemBaixaEfetivaBoletoDelegate
 * 
 * @author George.Santos
 */
public class MensagemBaixaEfetivaBoletoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemBaixaEfetivaBoletoServico {
     ...
     */
    @Override
    protected MensagemBaixaEfetivaBoletoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemBaixaEfetivaBoletoServico();
    }
     ...
     * {@inheritDoc}
     * 
     * @see br.com.sicoob.sisbr.sicoobdda.integracaocip.negocio.servicos.MensagemBaixaEfetivaBoletoServico#processarRetornoMensagemDDA(long, java.lang.String, java.lang.String)
     */
