...
/**
 * MensagemExcluirTerceiroAutorizadoDelegate
 * 
 * @author George.Santos
 */
public class MensagemExcluirTerceiroAutorizadoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemExcluirTerceiroAutorizadoServico {
     ...
     */
    @Override
    protected MensagemExcluirTerceiroAutorizadoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemExcluirTerceiroAutorizadoServico();
    }
