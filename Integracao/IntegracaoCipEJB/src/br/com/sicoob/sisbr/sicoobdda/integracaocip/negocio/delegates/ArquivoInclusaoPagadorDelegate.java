 ...
 */
public class ArquivoInclusaoPagadorDelegate extends IntegracaoCipArquivoDelegate<IntegracaoCipServico> implements ArquivoInclusaoPagadorServico {
     ...
     */
    @Override
    protected ArquivoInclusaoPagadorServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarArquivoInclusaoPagadorServico();
    }
