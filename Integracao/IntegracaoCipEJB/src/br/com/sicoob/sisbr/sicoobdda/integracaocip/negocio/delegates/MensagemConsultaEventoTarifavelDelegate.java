 ...
 * Arquivo:         MensagemConsultaEventoTarifavelDelegate.java
...
/**
 * MensagemConsultaEventoTarifavelDelegate é responsável por
 * 
 * @author Felipe.Rosa
 */
public class MensagemConsultaEventoTarifavelDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemConsultaEventoTarifavelServico {
     ...
     */
    @Override
    protected MensagemConsultaEventoTarifavelServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemConsultaEventoTarifavelServico();
    }
