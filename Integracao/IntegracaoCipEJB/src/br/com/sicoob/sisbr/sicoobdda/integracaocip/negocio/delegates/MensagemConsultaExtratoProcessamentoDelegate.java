 ...
 * Arquivo:         MensagemConsultaExtratoProcessamentoDelegate.java
...
/**
 * MensagemConsultaExtratoProcessamentoDelegate é responsável por
 * 
 * @author Felipe.Rosa
 */
public class MensagemConsultaExtratoProcessamentoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemConsultaExtratoProcessamentoServico {
     ...
     */
    @Override
    protected MensagemConsultaExtratoProcessamentoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemConsultaExtratoProcessamentoServico();
    }
