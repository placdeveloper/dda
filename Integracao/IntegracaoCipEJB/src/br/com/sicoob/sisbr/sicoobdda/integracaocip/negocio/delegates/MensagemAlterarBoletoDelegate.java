 ...
 */
public class MensagemAlterarBoletoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemAlterarBoletoServico {
     ...
     */
    @Override
    protected MensagemAlterarBoletoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemAlterarBoletoServico();
    }
