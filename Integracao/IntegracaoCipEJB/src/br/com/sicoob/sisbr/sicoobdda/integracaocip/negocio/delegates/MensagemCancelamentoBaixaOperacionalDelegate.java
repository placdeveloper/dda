...
/**
 * MensagemCancelamentoBaixaOperacionalDelegate
 * 
 * @author George.Santos
 */
public class MensagemCancelamentoBaixaOperacionalDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemCancelamentoBaixaOperacionalServico {
     ...
     */
    @Override
    protected MensagemCancelamentoBaixaOperacionalServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemCancelamentoBaixaOperacionalServico();
    }
