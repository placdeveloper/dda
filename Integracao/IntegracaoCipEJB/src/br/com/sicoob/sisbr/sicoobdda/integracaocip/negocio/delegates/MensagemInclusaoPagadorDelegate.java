...
/**
 * MensagemInclusaoPagadorDelegate
 * 
 * @author George.Santos
 */
public class MensagemInclusaoPagadorDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemInclusaoPagadorServico {
     ...
     */
    @Override
    protected MensagemInclusaoPagadorServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemInclusaoPagadorServico();
    }
