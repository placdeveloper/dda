...
/**
 * MensagemAlterarAceiteBoletoDelegate é responsável por
 * 
 * @author George.Santos
 */
public class MensagemAlterarAceiteBoletoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemAlterarAceiteBoletoServico {
    ...
    @Override
    protected MensagemAlterarAceiteBoletoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemAlterarAceiteBoletoServico();
    }
