...
/**
 * MensagemInclusaoBoletoDelegate
 * 
 * @author George.Santos
 */
public class MensagemInclusaoBoletoDelegate extends IntegracaoCipMensagemDelegate<IntegracaoCipServico> implements MensagemInclusaoBoletoServico {
     ...
     */
    @Override
    protected MensagemInclusaoBoletoServico localizarServico() {
        return IntegracaoCipServiceLocator.getInstance().localizarMensagemInclusaoBoletoServico();
    }
