...
/**
 * ConsultaBoletoDDADto é responsável por
 * 
 * @author Rodrigo.Neri
 */
public class ConsultaBoletoDDADto extends BancoobDto {

    private static final long serialVersionUID = 4980304060794855589L;
    ...
    private DateTimeDB dataLimitePagamentoBoleto;
    ...
    private DateTimeDB dataVencimentoUtil;
    ...
    // **********************************************************
    // CAMPOS QUE NÃO SÃO RETORNADOS NA SP NEM NO SERVIÇO DE API
    // Utilizados apenas durante o serviço de consulta
    // **********************************************************
    ...
    // Objeto preenchido quando feita a consulta na JDDDA
    private String descInstituicaoEmissoraTemp;
     ...
     */
    public DateTimeDB getDataLimitePagamentoBoleto() {
     ...
     */
    public void setDataLimitePagamentoBoleto(DateTimeDB dataLimitePagamentoBoleto) {
    ...
    /**
     * @return o atributo nomeInstituicaoEmissora
     */
    ...
    /**
     * Define o atributo nomeInstituicaoEmissora
     */
    public void setNomeInstituicaoEmissora(String nomeInstituicaoEmissora) {
     ...
     */
    public DateTimeDB getDataVencimentoUtil() {
     ...
     */
    public void setDataVencimentoUtil(DateTimeDB dataVencimentoUtil) {
    ...
    /**
     * @return o atributo descInstituicaoEmissoraTemp
     */
    public String getDescInstituicaoEmissoraTemp() {
        return descInstituicaoEmissoraTemp;
    }

    /**
     * Define o atributo descInstituicaoEmissoraTemp
     */
    public void setDescInstituicaoEmissoraTemp(String descInstituicaoEmissoraTemp) {
        this.descInstituicaoEmissoraTemp = descInstituicaoEmissoraTemp;
    }

    /**
     * Método responsável por obter o número da instituição mais o nome.
     * 
     * @return String
     */
    public String getDescInstituicaoEmissora() {
        // Se o objeto foi preenchido retorna ele
        if (!ObjectUtil.isEmpty(descInstituicaoEmissoraTemp)) {
            return descInstituicaoEmissoraTemp;
        }

        StringBuffer sb = new StringBuffer();

        // Se possuir o número da instituição emissora
        if (numInstituicaoEmissora != null) {
            sb.append(numInstituicaoEmissora);
            sb.append(" - ");
        }

        sb.append(nomeInstituicaoEmissora);
