 ...
 * Arquivo:         PagadorAgregadoDto.java
 ...
 * @author Felipe.Rosa
 */
@Conversor(DTO = "br.com.sicoob.sisbr.sicoobdda.comumfachada.dto.PagadorAgregadoDTO")
public class PagadorAgregadoDto extends BancoobDto {

    /**
     * 
     */
    private static final long serialVersionUID = -3901318336562406040L;
     ...
     * @param nomePessoa
     */
    public PagadorAgregadoDto(String numCpfCnpj, String nomePessoa) {
        this.numCpfCnpj = numCpfCnpj;
        this.nomePessoa = nomePessoa;
    }

    public PagadorAgregadoDto(String numCpfCnpj, String codTipoPessoa, String nomePessoa) {
        this.numCpfCnpj = numCpfCnpj;
        this.nomePessoa = nomePessoa;
        this.codTipoPessoa = codTipoPessoa;
    }

    public PagadorAgregadoDto(Long idPagadorDDA, String numCpfCnpj, String codTipoPessoa, String nomePessoa, String numCpfCnpjPagador, String nomePessoaPagador,
            Integer qtdAdesaoDDAPagador) {
