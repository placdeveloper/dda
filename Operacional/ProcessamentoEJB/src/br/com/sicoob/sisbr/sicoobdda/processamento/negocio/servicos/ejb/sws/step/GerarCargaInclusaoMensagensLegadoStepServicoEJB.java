...
/**
 * GerarCargaInclusaoMensagensLegadoStepServicoEJB
 * 
 * @author GEorge.santos
 */
@Stateless
@Remote(StepServico.class)
public class GerarCargaInclusaoMensagensLegadoStepServicoEJB extends StepSicoobServico {
    ...
    public RetornoExecucao executar(ContextoExecucao contexto) {
        ...
        log("************ INICIO EXECUCAO STEP GERAR INCLUSÃO CARGA MENSAGENS LEGADO *************");
        log(Constantes.STR_SEPARACAO);
        ...
        try {
            ...
            log("EFETUANDO CARGA DADOS LEGADO - INCLUSÃO");
            getProcessarCargaMensagensDelegate().gerarCargaDadosLegadoInclusao(numCooperativa);
    ...
    private static ISicoobLogger getLogger() {
        return SicoobLoggerPadrao.getInstance(GerarCargaInclusaoMensagensLegadoStepServicoEJB.class);
    }
