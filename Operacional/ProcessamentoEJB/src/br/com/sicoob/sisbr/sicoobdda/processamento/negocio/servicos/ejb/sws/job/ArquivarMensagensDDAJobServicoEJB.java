...
/**
 * ArquivarMensagensDDAJobServicoEJB
 * 
 * @author George.santos
 */
@Stateless
@Remote(JobServico.class)
public class ArquivarMensagensDDAJobServicoEJB extends JobSicoobServico {

    private static final String JNDI_STEP_MENSAGEMDDA = "sicoobdda_processamento/ArquivarMensagensDDAStepServicoRemote";
    private static final int TIMEOUT_STEP = 3600;
    ...
    public List<Step> obterSteps(ContextoExecucao contexto) {
        ...
        listaSteps.add(ejb(JNDI_STEP_MENSAGEMDDA).comTimeout(TIMEOUT_STEP).realizandoEsforcoDe(1.0));
        return listaSteps;
    }
    ...
    private static ISicoobLogger getLogger() {
        return SicoobLoggerPadrao.getInstance(ArquivarMensagensDDAJobServicoEJB.class);
    }
