...
public class DesbloquearMotorRecebimentoArquivoCIPJobServicoEJB extends JobSicoobServico {
    ...
    public List<Step> obterSteps(ContextoExecucao contexto) {
        ...
        TipoInstanciaProcessamentoEnum instancia = TipoInstanciaProcessamentoEnum.valueOf(valorParametro);

        List<Step> listaSteps = new ArrayList<Step>();
        Parametro paramParametroDDA = new Parametro("idParametro", instancia.getIdParametroMotorRecebimento(), TipoParametro.LONGO);
