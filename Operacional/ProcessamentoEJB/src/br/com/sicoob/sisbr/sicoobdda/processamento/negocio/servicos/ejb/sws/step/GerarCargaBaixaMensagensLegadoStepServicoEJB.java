...
/**
 * GerarCargaBaixaMensagensLegadoStepServicoEJB é responsável por
 * 
 * @author George.Santos
 */
@Stateless
@Remote(StepServico.class)
public class GerarCargaBaixaMensagensLegadoStepServicoEJB extends StepSicoobServico {
    ...
    public RetornoExecucao executar(ContextoExecucao contexto) {
        ...
        log("************ INICIO EXECUCAO STEP GERAR BAIXA CARGA MENSAGENS LEGADO *************");
        log(Constantes.STR_SEPARACAO);
        ...
        try {
            ...
            log("EFETUANDO CARGA DADOS LEGADO - Baixa");
            getProcessarCargaMensagensDelegate().gerarCargaDadosLegadoBaixa(numCooperativa);
    ...
    private static ISicoobLogger getLogger() {
        return SicoobLoggerPadrao.getInstance(GerarCargaBaixaMensagensLegadoStepServicoEJB.class);
    }
