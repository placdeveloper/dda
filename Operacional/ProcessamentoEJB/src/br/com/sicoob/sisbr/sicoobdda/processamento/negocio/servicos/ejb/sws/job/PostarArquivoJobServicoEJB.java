...
public class PostarArquivoJobServicoEJB extends JobSicoobServico {

    private static final String JNDI_STEP = "sicoobdda_processamento/PostarArquivoStepServicoRemote";
    private static final int TIMEOUT_STEP = 1800;
    ...
    private List<Long> obterListaIdEnvioArquivoDDA() {
        ...
        try {
            listaEnvioArquivoDDA = processamentoSWSDao.listarIdLogEnvioArquivoDDAPostarArquivo();
    ...
    private static ISicoobLogger getLogger() {
        return SicoobLoggerPadrao.getInstance(PostarArquivoJobServicoEJB.class);
    }
