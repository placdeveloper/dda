...
public class ProcessarEnvioMensagensStepServicoEJB extends StepSicoobServico {
    ...
    public RetornoExecucao executar(ContextoExecucao contexto) {
        try {
            ...
            getProcessarEnvioMensagensDelegate().processarEnvioMensagensNaoPrioritarias(numAgrupamentoSteps);
