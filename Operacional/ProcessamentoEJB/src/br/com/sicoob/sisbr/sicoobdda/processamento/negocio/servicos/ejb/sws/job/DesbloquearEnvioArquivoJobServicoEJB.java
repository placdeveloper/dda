...
public class DesbloquearEnvioArquivoJobServicoEJB extends JobSicoobServico {
    ...
    public List<Step> obterSteps(ContextoExecucao contexto) {
        ...
        Parametro paramParametroDDA = new Parametro("idParametro", ParametroDDA.MOTOR_ENVIO_ARQUIVO_EM_EXECUCAO, TipoParametro.LONGO);
